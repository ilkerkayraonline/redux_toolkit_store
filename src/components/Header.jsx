    ...
    <div className='flex items-center justify-between bg-indigo-600 text-white px-4 py-3'>
        ...
        <div className='flex items-center gap-5'>
           <div className='text-black'>
            <select onChange={e => dispatch(sortingDataFunc(e.target.value))} className='h-8 rounded' name="" id="">
                <option value="asc">ARTAN</option>
                <option value="desc">AZALAN</option>
            </select>
            </div> 
            <div>
                <input onChange={e => dispatch(searchDataFunc(e.target.value))} className='h-8 rounded px-4 text-black' type="text" placeholder='Arama yapınız...' />
            </div>
